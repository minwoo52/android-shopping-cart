...
- [ ] 장바구니 페이지
  ...
  - [x] 결제 버튼 총합 표시
- [x] 화면 테스트코드 작성
  - [x] 시나리오 : 담긴_상품_가격의_총합이_노출된다
  - [x] 시나리오 : 담긴_상품을_제거할_수_있다
  - [x] 시나리오 : 담긴_상품의_수량을_증가시키면_상품_가격에_반영된다
  - [x] 시나리오 : 담긴_상품의_수량을_감소시키면_상품_가격에_반영된다
  - [x] 시나리오 : 담긴_상품의_수량을_1보다_적게_하면_상품이_삭제된다
